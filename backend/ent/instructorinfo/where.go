...
func PHONENUMBER(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
...
func PHONENUMBEREQ(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPHONENUMBER), v))
	})
}
...
func PHONENUMBERNEQ(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
...
func PHONENUMBERIn(vs ...int) predicate.InstructorInfo {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PHONENUMBERNotIn(vs ...int) predicate.InstructorInfo {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PHONENUMBERGT(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
...
func PHONENUMBERGTE(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
...
func PHONENUMBERLT(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
...
func PHONENUMBERLTE(v int) predicate.InstructorInfo {
	return predicate.InstructorInfo(func(s *sql.Selector) {
