...
// was not loaded in eager-loading.
func (e DegreeEdges) SubjectsOfferedOrErr() ([]*SubjectsOffered, error) {
	if e.loadedTypes[1] {
...
// QuerySubjectsOffered queries the SubjectsOffered edge of the Degree.
func (d *Degree) QuerySubjectsOffered() *SubjectsOfferedQuery {
	return (&DegreeClient{config: d.config}).QuerySubjectsOffered(d)
}
