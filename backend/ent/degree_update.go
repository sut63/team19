...
func (du *DegreeUpdate) AddSubjectsOfferedIDs(ids ...int) *DegreeUpdate {
	du.mutation.AddSubjectsOfferedIDs(ids...)
	return du
}

// AddSubjectsOffered adds the SubjectsOffered edges to SubjectsOffered.
func (du *DegreeUpdate) AddSubjectsOffered(s ...*SubjectsOffered) *DegreeUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return du.AddSubjectsOfferedIDs(ids...)
}
...
func (du *DegreeUpdate) RemoveSubjectsOfferedIDs(ids ...int) *DegreeUpdate {
	du.mutation.RemoveSubjectsOfferedIDs(ids...)
	return du
}

// RemoveSubjectsOffered removes SubjectsOffered edges to SubjectsOffered.
func (du *DegreeUpdate) RemoveSubjectsOffered(s ...*SubjectsOffered) *DegreeUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return du.RemoveSubjectsOfferedIDs(ids...)
}
...
func (du *DegreeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := du.mutation.RemovedSubjectsOfferedIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := du.mutation.SubjectsOfferedIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   degree.SubjectsOfferedTable,
...
// AddSubjectsOfferedIDs adds the SubjectsOffered edge to SubjectsOffered by ids.
func (duo *DegreeUpdateOne) AddSubjectsOfferedIDs(ids ...int) *DegreeUpdateOne {
	duo.mutation.AddSubjectsOfferedIDs(ids...)
	return duo
}

// AddSubjectsOffered adds the SubjectsOffered edges to SubjectsOffered.
func (duo *DegreeUpdateOne) AddSubjectsOffered(s ...*SubjectsOffered) *DegreeUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return duo.AddSubjectsOfferedIDs(ids...)
}
...
// RemoveSubjectsOfferedIDs removes the SubjectsOffered edge to SubjectsOffered by ids.
func (duo *DegreeUpdateOne) RemoveSubjectsOfferedIDs(ids ...int) *DegreeUpdateOne {
	duo.mutation.RemoveSubjectsOfferedIDs(ids...)
	return duo
}

// RemoveSubjectsOffered removes SubjectsOffered edges to SubjectsOffered.
func (duo *DegreeUpdateOne) RemoveSubjectsOffered(s ...*SubjectsOffered) *DegreeUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return duo.RemoveSubjectsOfferedIDs(ids...)
}
...
func (duo *DegreeUpdateOne) sqlSave(ctx context.Context) (d *Degree, err error) {
	...
	if nodes := duo.mutation.RemovedSubjectsOfferedIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   degree.SubjectsOfferedTable,
	...
	if nodes := duo.mutation.SubjectsOfferedIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   degree.SubjectsOfferedTable,
