...
func (iiu *InstructorInfoUpdate) SetPHONENUMBER(i int) *InstructorInfoUpdate {
	iiu.mutation.ResetPHONENUMBER()
	iiu.mutation.SetPHONENUMBER(i)
	return iiu
}

// AddPHONENUMBER adds i to PHONENUMBER.
func (iiu *InstructorInfoUpdate) AddPHONENUMBER(i int) *InstructorInfoUpdate {
	iiu.mutation.AddPHONENUMBER(i)
	return iiu
}
...
func (iiu *InstructorInfoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := iiu.mutation.AddedPHONENUMBER(); ok {
...
// SetPHONENUMBER sets the PHONENUMBER field.
func (iiuo *InstructorInfoUpdateOne) SetPHONENUMBER(i int) *InstructorInfoUpdateOne {
	iiuo.mutation.ResetPHONENUMBER()
	iiuo.mutation.SetPHONENUMBER(i)
	return iiuo
}

// AddPHONENUMBER adds i to PHONENUMBER.
func (iiuo *InstructorInfoUpdateOne) AddPHONENUMBER(i int) *InstructorInfoUpdateOne {
	iiuo.mutation.AddPHONENUMBER(i)
	return iiuo
}
...
func (iiuo *InstructorInfoUpdateOne) sqlSave(ctx context.Context) (ii *InstructorInfo, err error) {
	...
	if value, ok := iiuo.mutation.AddedPHONENUMBER(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: instructorinfo.FieldPHONENUMBER,
